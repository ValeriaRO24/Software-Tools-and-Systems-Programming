...
int main(int argc, char **argv) {
    ...
    memset(greeting, 20, '\0');
    strncpy(greeting, argv[1], 19);
    greeting[19] = '\0';
    size_t len = strnlen(greeting, (size_t) 20);
    strncpy(greeting + len, " ", (size_t) (20 - len));
    len = strnlen(greeting, (size_t) 20);
    strncpy(greeting + len, argv[2], (size_t) (20 - len));
